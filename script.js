                    ...
                    for (var j = 0; j < myObj.SemesterList[r].SemesterData[k].ClassIDlist.length; j++) {
                        (function(j) {
                            ...
                            for (var i = 0; i < profName.length; i++) {
                                if (!profList.includes(profName[i].replace(/\s+$/, ""))) profList.push(profName[i].replace(/\s+$/, ""));
                            }
                        })(j);
                    }
                })(k);
        ...
        (function(r) {
            for (var j = 0; j < myObj.SemesterList[r].SemesterData.length; j++) {
                (function(j) {
                    ...
                    if (!classList.includes(className.replace(/\s+$/, ""))) classList.push(className.replace(/\s+$/, ""));
                })(j);
            }
        })(r);
    }
...
//https://stackoverflow.com/questions/8993773/javascript-contains-case-insensitive
                    ...
                    for (var j = 0; j < myObj.SemesterList[r].SemesterData[k].ClassIDlist.length; j++) {
                        (function(j) {
                            ...
                            for (var i = 0; i < careerSearch.length; i++) {
                                if (careerName == careerSearch[i]) careerContinues = true;
                            }
                            ...
                            if (indexOfCaseInsenstive(profName, searchProf) > -1 & careerContinues & semesterContinues & indexOfCaseInsenstive(className, classSearch) > -1) {
                ...
                (function(u) {
                    for (var z = 1; z < document.querySelectorAll("." + duplicate)[u].parentElement.children.length; z++) {
                        (function(z) {
                            ...
                            if (c) document.querySelectorAll("." + duplicate)[0].parentElement.appendChild(c);
                                ...
                                if (constrainList.includes("sectionContainer" + count)) {
                                    for (var i = titleEnd; i < pathText.length + 3; i++) {
                                        ...
                                        if (i == 10 & indexOfCaseInsenstive(path[i], "Staff") == -1) {
                                            ...
                                            if (lastString == "") var lastString = path[i];
...
function startSearch() {
    ...
    for (var i = 0; i < allSemester; i++) {
        ...
        if (s.checked) semesterSearch.push(s.name);
    }
    var allCareer = 2;
    for (var i = 0; i < allCareer; i++) {
        var c = document.getElementById("career" + (i + 1));
        if (c.checked) careerSearch.push(c.name);
    }
    init();
}