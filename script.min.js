...
function searchFn(){UIMenu.checkConstraint()}function waitFor(a){var b=function(c){a()?c():setTimeout(function(a){return b(c)},400)};return new Promise(b)}var DataList=new Data,FilterMenu=new Filter,UIMenu=new UI;
(function(){var a,b,c,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){switch(d.nextAddress){case 1:return d.yield(waitFor(function(a){return DataList.m_MEdata}),2);case 2:a=0;case 3:return a<DataList.m_MEdata.SemesterList.length?d.yield(UIMenu.createSection(a,DataList.m_MEdata.SemesterList[a].SemesterData.length),6):d.yield(UIMenu.sortClasses(),12);case 6:b=0;case 7:if(!(b<DataList.m_MEdata.SemesterList[a].SemesterData.length)){a++;d.jumpTo(3);break}c=document.getElementById(filterClassID(a,
b)+"Content");return d.yield(UIMenu.createSeason(c,a,b),10);case 10:return e=document.getElementById(filterClassIDBySeason(a,b)+"Content"),d.yield(UIMenu.createDiv(e,a,b,DataList.m_MEdata.SemesterList[a].SemesterData[b].ClassIDlist.length),8);case 8:b++;d.jumpTo(7);break;case 12:return d.yield(UIMenu.highLightClasses(document.querySelectorAll(".classBoxes")[0].children[0]),13);case 13:return d.yield(UIMenu.highLightClasses(document.querySelectorAll(".classBoxes")[0].children[1]),14);case 14:return d.yield(FilterMenu.Init(),
15);case 15:$(".ui.accordion").accordion({exclusive:!1}),$("#clear").on("click",function(){$(".ui.dropdown").dropdown("restore defaults")}),d.jumpToEnd()}})})();
